...
function SectionDivider() {
  return (
    <>
      ...
      >
        {/* <Container> */}
        <div className="child-divider"><img className="divider-img" src={hand} alt="handshake"/><h3>Reach Out</h3></div>
        <div className="child-divider"><img className="divider-img" src={growth} alt= "a plant in hand"/><h3>Find Meaning</h3></div>
        <div className="child-divider"><img className="divider-img" src={yinyang} alt="yin-yang symbol in head"/><h3>Find Healing</h3></div>
      </div>
